...
import '../../core/widgets/app_bottom_nav.dart'; // Import your nav bar
...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
    ...
    return Scaffold(
      ...
      body: _loading
        ...
        child: SingleChildScrollView(
          padding: const EdgeInsets.fromLTRB(20, 0, 20, 120), // Bottom padding for FAB/Nav
          child: Column(
  ...
  // --- UI Methods (NO CHANGES MADE TO THESE) ---
